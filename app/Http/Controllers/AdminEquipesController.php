<?php namespace App\Http\Controllers;
	...
	class AdminEquipesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Imagem','name'=>'imagem','type'=>'upload','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Cargo','name'=>'cargo','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Descricao','name'=>'descricao','type'=>'wysiwyg','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Twiter','name'=>'twiter','type'=>'text','validation'=>'min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Facebook','name'=>'facebook','type'=>'text','validation'=>'min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Linkedin','name'=>'linkedin','type'=>'text','validation'=>'min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Ativo','name'=>'ativo','type'=>'radio','validation'=>'min:1|max:255','width'=>'col-sm-10','dataenum'=>'1;0'];
			...
			//$this->form[] = ["label"=>"Twiter","name"=>"twiter","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
